...
// Phase D: legacy `generateInvoice` server action + its `daysBetweenInclusive`
// helper removed. Superseded by /api/admin/jobs/[id]/generate-invoice (which
// produces a properly-rendered draft via lib/stripe/invoice-generator). The
// new flow is invoked by the inline server action in
// src/app/admin/jobs/[id]/page.tsx → "Generate invoice" button.
